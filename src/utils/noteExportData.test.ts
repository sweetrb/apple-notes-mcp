...
const FULL_COLUMNS =
  "Z_PK INTEGER PRIMARY KEY, ZIDENTIFIER TEXT, ZTYPEUTI TEXT, ZTYPEUTI1 TEXT, ZNOTE INTEGER, " +
...
beforeAll(() => {
  ...
  execFileSync("/usr/bin/sqlite3", [
    ...
    `CREATE TABLE ZICCLOUDSYNCINGOBJECT (${FULL_COLUMNS});` +
      ...
      "INSERT INTO ZICCLOUDSYNCINGOBJECT (Z_PK, ZIDENTIFIER, ZTITLE1) VALUES (1, 'NOTE-1', 'Stored title'), (2, 'NOTE-2', NULL);" +
  ...
  execFileSync("/usr/bin/sqlite3", [
    ...
    "CREATE TABLE ZICCLOUDSYNCINGOBJECT (Z_PK INTEGER PRIMARY KEY, ZIDENTIFIER TEXT);" +
      "CREATE TABLE ZICNOTEDATA (Z_PK INTEGER PRIMARY KEY, ZNOTE INTEGER, ZCRYPTOINITIALIZATIONVECTOR BLOB, ZDATA BLOB);" +
      "INSERT INTO ZICCLOUDSYNCINGOBJECT VALUES (1, 'NOTE-1');" +
